...
1.	Create a vector from 1 to 50. Then, using R only, calculate how many elements of this vector are higher or equal than the positive square root of 100. *Positive square root can be calculated with the `sqrt()` function.<br>
