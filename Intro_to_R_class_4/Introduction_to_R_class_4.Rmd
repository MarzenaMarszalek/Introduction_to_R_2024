...
<span style="color: green">**Obtain the observations from `my_data` sorted with increasing levels of glycogen.* Use the `arragne()` function.*</span>
...
<span style="color: green">**Using `arragne()` function sort the observations from `my_data` with the decreasing levels of glycogen.**</span>
...
<span style="color: green">**Using `mutate()` fynction create a new column called `log_Gly` that will be a natural logarithm transformation of `Glycogen` column. Overwrite `my_data`**</span>
