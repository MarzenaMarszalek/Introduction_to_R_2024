...
<span style="color: green">**Descriptions of exercises to be done during classes are in green**</span>  
<span style="color: #3b50dbff">**Descriptions of exercises to be done at home are in blue**</span>  
...
<span style="color: #3b50dbff">**Calculate the area of a circle if the radius equals 40 meters.**</span>
...
<span style="color: #3b50dbff">**Using the equation for Shannon - Wiener index and species frequencies shown below, calculate diversity for both populations separately. Which is more diverse (higher values reflect more diverse populations)?**</span>
...
The expanded form of the the Shannon-Wiener diversity index formula:

$$
H_{SW}
= p_1 \cdot \ln\left(\frac{1}{p_1}\right)
+ p_2 \cdot \ln\left(\frac{1}{p_2}\right)
+ \cdots
+ p_S \cdot \ln\left(\frac{1}{p_S}\right)
$$
<br>
...
<span style="color: green">**Using the table from exercise 5, calculate the range of species frequencies (difference between the highest and lowest frequencies of species in a population) for both populations and save them as separate variables. Then, using chosen names, calculate the absolute difference between ranges. Save it to a variable called `range_diff` and call it.**</span>
