...
Some common causes for errors in R can be:
  ...
  -	<span style="color: red">**Error in [function()]: could not find function “function()”**</span> – either the function name is misspelled or you are trying to use a function from a library that isn’t installed or loaded; can also happen with old code when the name of a function updates – in this case, RStudio will sometimes suggest the new name, otherwise it can be found on the internet  
...
<span style="color: darkorange">
  ...
  2.	Upload the "homework_data.xlsx" file into the RStudio using your preferred method. Include the code for uploading the file into the script. *Remember that some upload methods require libraries to be loaded first.<br>
  ...
  5.	Save your result as a .csv file using `write.table()` function. Call the .csv file “class_2_sorted_column_Your_Name.csv”.
...
print("Ex. 5")
write.table(homework_data, "Class_2_sorted_column_Your_Name.csv")
```
