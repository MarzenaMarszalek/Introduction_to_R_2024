...
<span style="color: green;">**Create a new script file and save it. Call it as you wish. Write code for all subsequent exercises using the Code editor. Remember that to obtain any outcome/result, you need to run your code first.**</span>
...
**Every time you boot up RStudio, remember to:**  
  ...
  -	<span style='color: blue'>**copy and update the name of your script file (e.g. with that day’s date)**</span> – if you are working on a previously created file and want to **keep track of multiple versions** 
