...
<span style="color: darkorange">
  ...
  2.	Upload the "homework_data.xlsx" file into the RStudio using your preferred method. **Include the code for uploading the file into the script**. Remember that some upload methods require packages to be loaded first.<br>
