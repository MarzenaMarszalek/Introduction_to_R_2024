...
<span style="color: green;">**Download the [class_2_data.xlsx](class_2_data.xlsx) file and save it in your working directory. Then, upload the file into R using theRStudio user interface.**</span>
...
<span style="color: green">**Check the `Packages` tab (the lower right panel). You will see a list of installed packages**</span>
...
<span style="color: green;">**Install the `tidyverse` package using the `install.packages()` function. Then, [see here](https://www.tidyverse.org/). Check the `Packages` tab - a newly installed package should appear there!**</span>

#### <span style="color: green;">**Exercise 6**</span>
<span style="color: green;">**Load the `dplyr` package. Find the `dplyr` function that allows you to select columns from a table based on their names.**</span>
