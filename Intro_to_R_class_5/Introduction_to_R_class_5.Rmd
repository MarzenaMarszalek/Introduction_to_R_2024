...
<span style="color: green">**Copy and modify the code from exercise 3. Add axes titles using the arguments `xlab` and `ylab`. Add the title of the plot using the `main` argument.**</span>
